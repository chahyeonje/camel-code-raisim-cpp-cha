...
int main(int argc, char* argv[]) {
    ...
    /// create objects
    world.addGround();
    auto robot = world.addArticulatedSystem("\\home\\cha\\raisimLib\\camel-code-raisim-cpp\\rsc\\camel_simple_pendulum.urdf");
    ...
    double desiredPosition = pi/6;
    double desiredVelocity = 0;
    double PGain=100;
    double DGain=15;

    jointVelocityTarget.setZero();
    jointNominalConfig << pi;
